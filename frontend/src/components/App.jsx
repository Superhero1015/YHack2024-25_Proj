...
function App() {
  ...
  const handleFormSubmit = async (address) => {
    ...
    try {
      ...
      navigate('/results'); // Navigate to the results page upon successful submission
    } catch (error) {
    ...
    <div>
      <Routes>
        ...
        <Route path="/results" element={
          resultData ? (
            <Result result={resultData} onSubmit={handleFormSubmit} />  // Pass the handleFormSubmit function to Result component
          ) : (
